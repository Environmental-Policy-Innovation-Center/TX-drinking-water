...
TX_enviro_surface[[2]] <- reservoirs
TX_enviro_surface[[3]] <- recent_reservoir_levels
TX_enviro_surface[[4]] <- reservoir_levels_10yr
TX_enviro_surface[[5]] <- major_river_basins
TX_enviro_surface[[6]] <- basin_impairment
names(TX_enviro_surface) <- c("surface_water_intakes", "reservoirs",
...
## Data crosswalking key & loading lists: 
```{r}
