...
leaflet() %>%
  ...
  addCircleMarkers(data = all_sw_intakes_final, 
                   fill = ~wtrbdy_pal(basin_name_short), 
                   color = ~wtrbdy_pal(basin_name_short), 
                   weight = 3, 
                   opacity = 9, 
                   radius = 3, 
                   label = paste0("pwsid: ", all_sw_intakes_final$pwsid, "; waterbody: ", 
                                  all_sw_intakes_final$res_name, 
                                  "; basin name: ", 
                                  all_sw_intakes_final$basin_name_short)) %>%
