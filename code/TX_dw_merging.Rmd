...
## Merging: demographics, financial, water delivery system: 
```{r}
names(demo)
names(fin)
names(wds)
# everything here is clean & easy to merge with either census geographies, 
# counties, or pwsids. 
```
...
# also want a key for variables included in most analyses, such as MHI, 
...
# if they're missing JUST the mhi column, that stat was NA in the census. 
