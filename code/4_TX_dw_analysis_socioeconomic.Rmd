...
all_cor = cor(all_data %>% select(c(healthbased_violations_5yr,paperwork_violations_5yr, 
                              paperwork_violations_10yr, healthbased_violations_10yr,
                              area_miles, pop_density, estimate_mhi, 
                              estimate_white_alone_per:estimate_poc_alone_per)), 
        use="pairwise.complete.obs")
corrplot(all_cor, method = 'number') 
```
