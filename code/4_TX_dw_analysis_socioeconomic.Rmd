...
ggplot(lqi_hcf, aes(x = estimate_mhi, y = hcf)) + 
  geom_point(aes(color = total_water_year + total_sewer_year)) + 
  scale_color_continuous(name = "$Water+Sewer/year") + 
  theme_minimal() + 
  labs(x = "Annual Median Household Income", 
       y = "Household Cost Factor") + 
  geom_vline(xintercept = 43900)
