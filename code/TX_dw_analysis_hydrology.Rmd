...
```{r}
# don't know if we can answer that question 
# Charles to reach out to Danielle for datasets or any extra 
# clarification 
```
...
# how many don't have a name match? 209
...
# there are still 124 pwsids missing: 
all_pwsid_names %>%
  filter(is.na(pwsid)) %>%
  distinct(name_of_utility_tidy)
# TODO: this info might be found on DWW if I remember correctly... might help
# match some of these but honeslty there's quite a few here that I could do 
# manually or with some fancy fuzzy string matching 
