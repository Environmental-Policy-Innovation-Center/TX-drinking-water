...
# looking at this in the form of a bar chart: 
# needs: 
proj_needs <- wds$TXSWP_needs
...
# quick histogram: 
ggplot(viols, aes(x = healthbased_violations_5yr)) + 
  geom_histogram(position = "identity", 
                 alpha = 0.5, 
                 bins = 12)  + 
  geom_histogram(data = etx_viols, fill = "pink", 
                 bins = 12)
...
mean(cvi_weighted_geoms$cvi_weighted_score)
median(cvi_weighted_geoms$cvi_weighted_score)

# working on just east tx: 
...
ggplot(pwsid_imp_basin_simp, 
       # aes(x = reorder(basin_name.x, -pct_impaired), 
       aes(x = total_pwsid, 
           y = pct_impaired,
           color = pct_impaired)) + 
  geom_point(size = 5) + 
